            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
						...
						<li>
                            <a href="#" onclick="populateCollegeProfile();" data-toggle="button"><i class="fa fa-files-o fa-fw"></i> College Profile<span class="fa fa-arrow-right" style="float:right"></span></a>
                        </li>
						<li>
                            <a href="#" onclick="populateAssessments();" data-toggle="button"><i class="fa fa-files-o fa-fw"></i> Assessments<span class="fa fa-arrow-right" style="float:right"></span></a>
                        </li>
						<li>
                            <a href="#" onclick="populateEvents();" data-toggle="button"><i class="fa fa-wrench fa-fw"></i> Events<span class="fa fa-arrow-right" style="float:right"></span></a>
                        </li>
						<li>
                            <a href="#" onclick="populateInvite();" data-toggle="button"><i class="fa fa-user fa-fw"></i> Invite<span class="fa fa-arrow-right" style="float:right"></span></a>
                        </li>

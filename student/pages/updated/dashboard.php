            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
						...
						<li>
                            <a href="#" onclick="populateStudentProfile();" data-toggle="button"><i class="fa fa-files-o fa-fw"></i> My Profile<span class="fa fa-arrow-right" style="float:right"></span></a>
                        </li>
						<li>

    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">HFM Admin Panel</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
						...
						<li>
                            <a href="#" onclick="populateCollegeAccounts();" data-toggle="button"><i class="fa fa-files-o fa-fw"></i> College Accounts<span class="fa fa-arrow-right" style="float:right"></span></a>
                        </li>
						<li>
                            <a href="#" onclick="populateStudentAccounts();" data-toggle="button"><i class="fa fa-files-o fa-fw"></i> Student Accounts<span class="fa fa-arrow-right" style="float:right"></span></a>
                        </li>
						<li>
                            <a href="#" onclick="populateEmployerAccounts();" data-toggle="button"><i class="fa fa-files-o fa-fw"></i> Employer Accounts<span class="fa fa-arrow-right" style="float:right"></span></a>
                        </li>
						<li>
                            <a href="#" onclick="populateSettings();" data-toggle="button"><i class="fa fa-wrench fa-fw"></i> Settings<span class="fa fa-arrow-right" style="float:right"></span></a>
                        </li>
